...
export const rawMaterials: RawMaterial[] = IS_DEPLOYED_PROD ? [] : [
  ...
  { id: 'r13', name: 'Fish Fillet', uom: 'kg', category: 'Meat', stock: 10, reorder: 8, unitCost: 420 },
  { id: 'r14', name: 'Black Lentils (Urad Dal)', uom: 'kg', category: 'Grains', stock: 25, reorder: 10, unitCost: 110 },
  { id: 'r15', name: 'Mixed Vegetables', uom: 'kg', category: 'Vegetables', stock: 20, reorder: 10, unitCost: 50 },
  { id: 'r16', name: 'Whole Wheat Flour (Atta)', uom: 'kg', category: 'Grains', stock: 30, reorder: 15, unitCost: 40 },
  { id: 'r17', name: 'Garlic', uom: 'kg', category: 'Vegetables', stock: 5, reorder: 3, unitCost: 160 },
  { id: 'r18', name: 'Potato', uom: 'kg', category: 'Vegetables', stock: 40, reorder: 15, unitCost: 25 },
  { id: 'r19', name: 'Milk & Curd', uom: 'L', category: 'Dairy', stock: 30, reorder: 15, unitCost: 60 },
  { id: 'r20', name: 'Sugar', uom: 'kg', category: 'Other', stock: 25, reorder: 10, unitCost: 42 },
  { id: 'r21', name: 'Lemon & Mint', uom: 'kg', category: 'Vegetables', stock: 5, reorder: 3, unitCost: 90 },
  { id: 'r22', name: 'Soda / Carbonated Water', uom: 'L', category: 'Beverages', stock: 40, reorder: 15, unitCost: 25 },
  { id: 'r23', name: 'Tea Leaves & Spices', uom: 'kg', category: 'Spices', stock: 4, reorder: 2, unitCost: 380 },
  { id: 'r24', name: 'Coffee Powder', uom: 'kg', category: 'Beverages', stock: 3, reorder: 2, unitCost: 650 },
  { id: 'r25', name: 'Khoya / Mawa', uom: 'kg', category: 'Dairy', stock: 8, reorder: 4, unitCost: 340 },
  { id: 'r26', name: 'Carrot (Red)', uom: 'kg', category: 'Vegetables', stock: 15, reorder: 5, unitCost: 45 },
  { id: 'r27', name: 'Nuts & Saffron', uom: 'kg', category: 'Spices', stock: 2, reorder: 1, unitCost: 1400 },
];
...
export const bomRecipes: BOMRecipe[] = [
  {
    id: 'bom-m1', menuItemId: 'm1', menuItemName: 'Paneer Tikka', category: 'starters',
    outputQty: 1, outputUom: 'portion', yieldPct: 96, wastagePct: 4,
    totalCost: 69.2, costPerServing: 69.2, suggestedPrice: 230, marginPct: 75.3,
    notes: 'Char-grilled cottage cheese in spiced marinade',
    components: [
      { materialId: 'r3', materialName: 'Paneer', qty: 0.2, uom: 'kg', unitCost: 280, totalCost: 56.0 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.1, uom: 'kg', unitCost: 32, totalCost: 3.2 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.02, uom: 'L', unitCost: 140, totalCost: 2.8 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.01, uom: 'kg', unitCost: 120, totalCost: 1.2 },
      { materialId: 'r12', materialName: 'Green Chilli', qty: 0.01, uom: 'kg', unitCost: 80, totalCost: 0.8 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.01, uom: 'kg', unitCost: 520, totalCost: 5.2 },
    ],
  },
  {
    id: 'bom-m2', menuItemId: 'm2', menuItemName: 'Chicken 65', category: 'starters',
    outputQty: 1, outputUom: 'portion', yieldPct: 94, wastagePct: 6,
    totalCost: 65.8, costPerServing: 65.8, suggestedPrice: 220, marginPct: 72.6,
    notes: 'Spicy fried chicken starter',
    components: [
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.22, uom: 'kg', unitCost: 240, totalCost: 52.8 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.04, uom: 'L', unitCost: 140, totalCost: 5.6 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.02, uom: 'kg', unitCost: 120, totalCost: 2.4 },
      { materialId: 'r12', materialName: 'Green Chilli', qty: 0.015, uom: 'kg', unitCost: 80, totalCost: 1.2 },
      { materialId: 'r23', materialName: 'Tea Leaves & Spices', qty: 0.01, uom: 'kg', unitCost: 380, totalCost: 3.8 },
    ],
  },
  {
    id: 'bom-m3', menuItemId: 'm3', menuItemName: 'Veg Spring Roll', category: 'starters',
    outputQty: 1, outputUom: 'portion', yieldPct: 95, wastagePct: 5,
    totalCost: 19.4, costPerServing: 19.4, suggestedPrice: 65, marginPct: 89.2,
    notes: 'Crispy rolls with vegetable filling',
    components: [
      { materialId: 'r15', materialName: 'Mixed Vegetables', qty: 0.2, uom: 'kg', unitCost: 50, totalCost: 10.0 },
      { materialId: 'r8', materialName: 'Maida (Refined Flour)', qty: 0.08, uom: 'kg', unitCost: 45, totalCost: 3.6 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.03, uom: 'L', unitCost: 140, totalCost: 4.2 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.05, uom: 'kg', unitCost: 32, totalCost: 1.6 },
    ],
  },
  {
    id: 'bom-m4', menuItemId: 'm4', menuItemName: 'Fish Amritsari', category: 'starters',
    outputQty: 1, outputUom: 'portion', yieldPct: 93, wastagePct: 7,
    totalCost: 102.2, costPerServing: 102.2, suggestedPrice: 340, marginPct: 68.1,
    notes: 'Crispy batter-fried fish fillets',
    components: [
      { materialId: 'r13', materialName: 'Fish Fillet', qty: 0.22, uom: 'kg', unitCost: 420, totalCost: 92.4 },
      { materialId: 'r8', materialName: 'Maida (Refined Flour)', qty: 0.04, uom: 'kg', unitCost: 45, totalCost: 1.8 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.02, uom: 'kg', unitCost: 120, totalCost: 2.4 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.04, uom: 'L', unitCost: 140, totalCost: 5.6 },
    ],
  },
  {
    id: 'bom-m5', menuItemId: 'm5', menuItemName: 'Butter Chicken', category: 'mains',
    outputQty: 1, outputUom: 'portion', yieldPct: 95, wastagePct: 5,
    totalCost: 88.0, costPerServing: 88.0, suggestedPrice: 295, marginPct: 74.1,
    notes: 'Creamy tomato gravy with tender chicken',
    components: [
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.2, uom: 'kg', unitCost: 240, totalCost: 48.0 },
      { materialId: 'r4', materialName: 'Tomatoes', qty: 0.25, uom: 'kg', unitCost: 40, totalCost: 10.0 },
      { materialId: 'r7', materialName: 'Fresh Cream', qty: 0.08, uom: 'L', unitCost: 180, totalCost: 14.4 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.03, uom: 'kg', unitCost: 520, totalCost: 15.6 },
    ],
  },
  {
    id: 'bom-m6', menuItemId: 'm6', menuItemName: 'Paneer Butter Masala', category: 'mains',
    outputQty: 1, outputUom: 'portion', yieldPct: 94, wastagePct: 6,
    totalCost: 75.2, costPerServing: 75.2, suggestedPrice: 250, marginPct: 74.9,
    notes: 'Rich makhani gravy with cottage cheese',
    components: [
      { materialId: 'r3', materialName: 'Paneer', qty: 0.18, uom: 'kg', unitCost: 280, totalCost: 50.4 },
      { materialId: 'r4', materialName: 'Tomatoes', qty: 0.2, uom: 'kg', unitCost: 40, totalCost: 8.0 },
      { materialId: 'r7', materialName: 'Fresh Cream', qty: 0.05, uom: 'L', unitCost: 180, totalCost: 9.0 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.015, uom: 'kg', unitCost: 520, totalCost: 7.8 },
    ],
  },
  {
    id: 'bom-m7', menuItemId: 'm7', menuItemName: 'Dal Makhani', category: 'mains',
    outputQty: 1, outputUom: 'portion', yieldPct: 95, wastagePct: 5,
    totalCost: 39.9, costPerServing: 39.9, suggestedPrice: 135, marginPct: 81.9,
    notes: 'Slow-cooked black lentils with butter and cream',
    components: [
      { materialId: 'r14', materialName: 'Black Lentils (Urad Dal)', qty: 0.15, uom: 'kg', unitCost: 110, totalCost: 16.5 },
      { materialId: 'r7', materialName: 'Fresh Cream', qty: 0.05, uom: 'L', unitCost: 180, totalCost: 9.0 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.02, uom: 'kg', unitCost: 520, totalCost: 10.4 },
      { materialId: 'r4', materialName: 'Tomatoes', qty: 0.1, uom: 'kg', unitCost: 40, totalCost: 4.0 },
    ],
  },
  {
    id: 'bom-m8', menuItemId: 'm8', menuItemName: 'Mutton Rogan Josh', category: 'mains',
    outputQty: 1, outputUom: 'portion', yieldPct: 90, wastagePct: 10,
    totalCost: 191.6, costPerServing: 191.6, suggestedPrice: 640, marginPct: 54.4,
    notes: 'Kashmiri style tender mutton curry',
    components: [
      { materialId: 'r11', materialName: 'Mutton', qty: 0.25, uom: 'kg', unitCost: 680, totalCost: 170.0 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.15, uom: 'kg', unitCost: 32, totalCost: 4.8 },
      { materialId: 'r4', materialName: 'Tomatoes', qty: 0.1, uom: 'kg', unitCost: 40, totalCost: 4.0 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.02, uom: 'kg', unitCost: 520, totalCost: 10.4 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.02, uom: 'kg', unitCost: 120, totalCost: 2.4 },
    ],
  ...
  {
    id: 'bom-m9', menuItemId: 'm9', menuItemName: 'Chicken Biryani', category: 'biryani',
    outputQty: 1, outputUom: 'portion', yieldPct: 92, wastagePct: 8,
    totalCost: 77.66, costPerServing: 77.66, suggestedPrice: 260, marginPct: 72.3,
    notes: 'Dum-cooked basmati with marinated chicken',
    components: [
      { materialId: 'r1', materialName: 'Basmati Rice', qty: 0.18, uom: 'kg', unitCost: 85, totalCost: 15.3 },
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.2, uom: 'kg', unitCost: 240, totalCost: 48.0 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.08, uom: 'kg', unitCost: 32, totalCost: 2.56 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.02, uom: 'kg', unitCost: 120, totalCost: 2.4 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.03, uom: 'L', unitCost: 140, totalCost: 4.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.01, uom: 'kg', unitCost: 520, totalCost: 5.2 },
    ],
  ...
  {
    id: 'bom-m10', menuItemId: 'm10', menuItemName: 'Veg Biryani', category: 'biryani',
    outputQty: 1, outputUom: 'portion', yieldPct: 94, wastagePct: 6,
    totalCost: 48.76, costPerServing: 48.76, suggestedPrice: 165, marginPct: 77.8,
    notes: 'Aromatic basmati rice with mixed vegetables and paneer',
    components: [
      { materialId: 'r1', materialName: 'Basmati Rice', qty: 0.18, uom: 'kg', unitCost: 85, totalCost: 15.3 },
      { materialId: 'r15', materialName: 'Mixed Vegetables', qty: 0.15, uom: 'kg', unitCost: 50, totalCost: 7.5 },
      { materialId: 'r3', materialName: 'Paneer', qty: 0.05, uom: 'kg', unitCost: 280, totalCost: 14.0 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.08, uom: 'kg', unitCost: 32, totalCost: 2.56 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.03, uom: 'L', unitCost: 140, totalCost: 4.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.01, uom: 'kg', unitCost: 520, totalCost: 5.2 },
    ],
  ...
  {
    id: 'bom-m11', menuItemId: 'm11', menuItemName: 'Mutton Biryani', category: 'biryani',
    outputQty: 1, outputUom: 'portion', yieldPct: 90, wastagePct: 10,
    totalCost: 180.1, costPerServing: 180.1, suggestedPrice: 600, marginPct: 52.6,
    notes: 'Rich aromatic mutton dum biryani',
    components: [
      { materialId: 'r1', materialName: 'Basmati Rice', qty: 0.18, uom: 'kg', unitCost: 85, totalCost: 15.3 },
      { materialId: 'r11', materialName: 'Mutton', qty: 0.22, uom: 'kg', unitCost: 680, totalCost: 149.6 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.1, uom: 'kg', unitCost: 32, totalCost: 3.2 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.03, uom: 'L', unitCost: 140, totalCost: 4.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.015, uom: 'kg', unitCost: 520, totalCost: 7.8 },
    ],
  ...
  {
    id: 'bom-m12', menuItemId: 'm12', menuItemName: 'Hyderabadi Biryani', category: 'biryani',
    outputQty: 1, outputUom: 'portion', yieldPct: 92, wastagePct: 8,
    totalCost: 85.0, costPerServing: 85.0, suggestedPrice: 285, marginPct: 73.4,
    notes: 'Spicy Hyderabadi style chicken biryani',
    components: [
      { materialId: 'r1', materialName: 'Basmati Rice', qty: 0.2, uom: 'kg', unitCost: 85, totalCost: 17.0 },
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.22, uom: 'kg', unitCost: 240, totalCost: 52.8 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.1, uom: 'kg', unitCost: 32, totalCost: 3.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.02, uom: 'kg', unitCost: 520, totalCost: 10.4 },
      { materialId: 'r12', materialName: 'Green Chilli', qty: 0.02, uom: 'kg', unitCost: 80, totalCost: 1.6 },
    ],
  },
  {
    id: 'bom-m13', menuItemId: 'm13', menuItemName: 'Tandoori Chicken (Half)', category: 'tandoor',
    outputQty: 1, outputUom: 'portion', yieldPct: 92, wastagePct: 8,
    totalCost: 96.0, costPerServing: 96.0, suggestedPrice: 320, marginPct: 63.1,
    notes: 'Classic clay-oven roasted chicken',
    components: [
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.35, uom: 'kg', unitCost: 240, totalCost: 84.0 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.02, uom: 'kg', unitCost: 120, totalCost: 2.4 },
      { materialId: 'r21', materialName: 'Lemon & Mint', qty: 0.02, uom: 'kg', unitCost: 90, totalCost: 1.8 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.015, uom: 'kg', unitCost: 520, totalCost: 7.8 },
    ],
  },
  {
    id: 'bom-m14', menuItemId: 'm14', menuItemName: 'Seekh Kebab', category: 'tandoor',
    outputQty: 1, outputUom: 'portion', yieldPct: 94, wastagePct: 6,
    totalCost: 57.4, costPerServing: 57.4, suggestedPrice: 190, marginPct: 76.1,
    notes: 'Minced spiced meat skewers',
    components: [
      { materialId: 'r2', materialName: 'Chicken (boneless)', qty: 0.2, uom: 'kg', unitCost: 240, totalCost: 48.0 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.05, uom: 'kg', unitCost: 32, totalCost: 1.6 },
      { materialId: 'r6', materialName: 'Ginger-Garlic Paste', qty: 0.015, uom: 'kg', unitCost: 120, totalCost: 1.8 },
      { materialId: 'r12', materialName: 'Green Chilli', qty: 0.01, uom: 'kg', unitCost: 80, totalCost: 0.8 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.01, uom: 'kg', unitCost: 520, totalCost: 5.2 },
    ],
  },
  {
    id: 'bom-m15', menuItemId: 'm15', menuItemName: 'Tandoori Roti', category: 'breads',
    outputQty: 1, outputUom: 'portion', yieldPct: 98, wastagePct: 2,
    totalCost: 5.8, costPerServing: 5.8, suggestedPrice: 20, marginPct: 80.7,
    notes: 'Whole wheat clay oven bread',
    components: [
      { materialId: 'r16', materialName: 'Whole Wheat Flour (Atta)', qty: 0.08, uom: 'kg', unitCost: 40, totalCost: 3.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.005, uom: 'kg', unitCost: 520, totalCost: 2.6 },
    ],
  },
  {
    id: 'bom-m16', menuItemId: 'm16', menuItemName: 'Butter Naan', category: 'breads',
    outputQty: 1, outputUom: 'portion', yieldPct: 97, wastagePct: 3,
    totalCost: 13.05, costPerServing: 13.05, suggestedPrice: 45, marginPct: 71.0,
    notes: 'Soft refined flour bread topped with butter',
    components: [
      { materialId: 'r8', materialName: 'Maida (Refined Flour)', qty: 0.09, uom: 'kg', unitCost: 45, totalCost: 4.05 },
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.02, uom: 'L', unitCost: 60, totalCost: 1.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.015, uom: 'kg', unitCost: 520, totalCost: 7.8 },
    ],
  },
  {
    id: 'bom-m17', menuItemId: 'm17', menuItemName: 'Garlic Naan', category: 'breads',
    outputQty: 1, outputUom: 'portion', yieldPct: 97, wastagePct: 3,
    totalCost: 15.05, costPerServing: 15.05, suggestedPrice: 50, marginPct: 72.6,
    notes: 'Naan topped with minced garlic & butter',
    components: [
      { materialId: 'r8', materialName: 'Maida (Refined Flour)', qty: 0.09, uom: 'kg', unitCost: 45, totalCost: 4.05 },
      { materialId: 'r17', materialName: 'Garlic', qty: 0.02, uom: 'kg', unitCost: 160, totalCost: 3.2 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.015, uom: 'kg', unitCost: 520, totalCost: 7.8 },
    ],
  },
  {
    id: 'bom-m18', menuItemId: 'm18', menuItemName: 'Masala Dosa', category: 'mains',
    outputQty: 1, outputUom: 'portion', yieldPct: 96, wastagePct: 4,
    totalCost: 19.25, costPerServing: 19.25, suggestedPrice: 65, marginPct: 86.2,
    notes: 'Crispy rice crepe filled with spiced potato',
    components: [
      { materialId: 'r1', materialName: 'Basmati Rice', qty: 0.1, uom: 'kg', unitCost: 85, totalCost: 8.5 },
      { materialId: 'r18', materialName: 'Potato', qty: 0.15, uom: 'kg', unitCost: 25, totalCost: 3.75 },
      { materialId: 'r5', materialName: 'Onions', qty: 0.05, uom: 'kg', unitCost: 32, totalCost: 1.6 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.02, uom: 'L', unitCost: 140, totalCost: 2.8 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.005, uom: 'kg', unitCost: 520, totalCost: 2.6 },
    ],
  ...
  {
    id: 'bom-m19', menuItemId: 'm19', menuItemName: 'Sweet Lassi', category: 'beverages',
    outputQty: 1, outputUom: 'portion', yieldPct: 98, wastagePct: 2,
    totalCost: 19.06, costPerServing: 19.06, suggestedPrice: 65, marginPct: 76.2,
    notes: 'Chilled churned yogurt drink with dry fruits',
    components: [
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.25, uom: 'L', unitCost: 60, totalCost: 15.0 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.03, uom: 'kg', unitCost: 42, totalCost: 1.26 },
      { materialId: 'r27', materialName: 'Nuts & Saffron', qty: 0.002, uom: 'kg', unitCost: 1400, totalCost: 2.8 },
    ],
  },
  {
    id: 'bom-m20', menuItemId: 'm20', menuItemName: 'Fresh Lime Soda', category: 'beverages',
    outputQty: 1, outputUom: 'portion', yieldPct: 99, wastagePct: 1,
    totalCost: 9.79, costPerServing: 9.79, suggestedPrice: 35, marginPct: 83.7,
    notes: 'Refreshing fizzy lime drink',
    components: [
      { materialId: 'r22', materialName: 'Soda / Carbonated Water', qty: 0.25, uom: 'L', unitCost: 25, totalCost: 6.25 },
      { materialId: 'r21', materialName: 'Lemon & Mint', qty: 0.03, uom: 'kg', unitCost: 90, totalCost: 2.7 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.02, uom: 'kg', unitCost: 42, totalCost: 0.84 },
    ],
  },
  {
    id: 'bom-m21', menuItemId: 'm21', menuItemName: 'Masala Chai', category: 'beverages',
    outputQty: 1, outputUom: 'portion', yieldPct: 98, wastagePct: 2,
    totalCost: 10.43, costPerServing: 10.43, suggestedPrice: 35, marginPct: 73.9,
    notes: 'Spiced Indian milk tea',
    components: [
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.1, uom: 'L', unitCost: 60, totalCost: 6.0 },
      { materialId: 'r23', materialName: 'Tea Leaves & Spices', qty: 0.01, uom: 'kg', unitCost: 380, totalCost: 3.8 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.015, uom: 'kg', unitCost: 42, totalCost: 0.63 },
    ],
  },
  {
    id: 'bom-m22', menuItemId: 'm22', menuItemName: 'Cold Coffee', category: 'beverages',
    outputQty: 1, outputUom: 'portion', yieldPct: 98, wastagePct: 2,
    totalCost: 26.4, costPerServing: 26.4, suggestedPrice: 90, marginPct: 78.0,
    notes: 'Creamy blended cold coffee',
    components: [
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.2, uom: 'L', unitCost: 60, totalCost: 12.0 },
      { materialId: 'r24', materialName: 'Coffee Powder', qty: 0.015, uom: 'kg', unitCost: 650, totalCost: 9.75 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.025, uom: 'kg', unitCost: 42, totalCost: 1.05 },
      { materialId: 'r7', materialName: 'Fresh Cream', qty: 0.02, uom: 'L', unitCost: 180, totalCost: 3.6 },
    ],
  },
  {
    id: 'bom-m23', menuItemId: 'm23', menuItemName: 'Gulab Jamun (2 pc)', category: 'desserts',
    outputQty: 1, outputUom: 'portion', yieldPct: 96, wastagePct: 4,
    totalCost: 33.36, costPerServing: 33.36, suggestedPrice: 110, marginPct: 62.9,
    notes: 'Warm fried dough balls in rose syrup',
    components: [
      { materialId: 'r25', materialName: 'Khoya / Mawa', qty: 0.08, uom: 'kg', unitCost: 340, totalCost: 27.2 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.08, uom: 'kg', unitCost: 42, totalCost: 3.36 },
      { materialId: 'r9', materialName: 'Cooking Oil', qty: 0.02, uom: 'L', unitCost: 140, totalCost: 2.8 },
    ],
  },
  {
    id: 'bom-m24', menuItemId: 'm24', menuItemName: 'Rasmalai (2 pc)', category: 'desserts',
    outputQty: 1, outputUom: 'portion', yieldPct: 96, wastagePct: 4,
    totalCost: 40.28, costPerServing: 40.28, suggestedPrice: 135, marginPct: 59.7,
    notes: 'Soft cottage cheese patties in saffron milk',
    components: [
      { materialId: 'r3', materialName: 'Paneer', qty: 0.08, uom: 'kg', unitCost: 280, totalCost: 22.4 },
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.2, uom: 'L', unitCost: 60, totalCost: 12.0 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.04, uom: 'kg', unitCost: 42, totalCost: 1.68 },
      { materialId: 'r27', materialName: 'Nuts & Saffron', qty: 0.003, uom: 'kg', unitCost: 1400, totalCost: 4.2 },
    ],
  },
  {
    id: 'bom-m25', menuItemId: 'm25', menuItemName: 'Gajar Halwa', category: 'desserts',
    outputQty: 1, outputUom: 'portion', yieldPct: 95, wastagePct: 5,
    totalCost: 35.13, costPerServing: 35.13, suggestedPrice: 115, marginPct: 68.1,
    notes: 'Rich carrot pudding with nuts & ghee',
    components: [
      { materialId: 'r26', materialName: 'Carrot (Red)', qty: 0.25, uom: 'kg', unitCost: 45, totalCost: 11.25 },
      { materialId: 'r19', materialName: 'Milk & Curd', qty: 0.15, uom: 'L', unitCost: 60, totalCost: 9.0 },
      { materialId: 'r20', materialName: 'Sugar', qty: 0.04, uom: 'kg', unitCost: 42, totalCost: 1.68 },
      { materialId: 'r10', materialName: 'Ghee', qty: 0.02, uom: 'kg', unitCost: 520, totalCost: 10.4 },
      { materialId: 'r27', materialName: 'Nuts & Saffron', qty: 0.002, uom: 'kg', unitCost: 1400, totalCost: 2.8 },
    ],
...
export const boqPlans: BOQPlan[] = [
  {
    id: 'boq-001',
    title: 'Weekend High-Volume Prep (Sat-Sun)',
    date: '2026-07-25',
    eventOrType: 'weekly_forecast',
    status: 'approved',
    items: [
      { menuItemId: 'm9', menuItemName: 'Chicken Biryani', targetQty: 60 },
      { menuItemId: 'm5', menuItemName: 'Butter Chicken', targetQty: 40 },
      { menuItemId: 'm6', menuItemName: 'Paneer Butter Masala', targetQty: 30 },
      { menuItemId: 'm1', menuItemName: 'Paneer Tikka', targetQty: 25 },
    ],
    requirements: [
      { materialId: 'r1', materialName: 'Basmati Rice', uom: 'kg', category: 'Grains', requiredQty: 11.7, currentStock: 42, shortageQty: 0, unitCost: 85, totalCost: 994.5 },
      { materialId: 'r2', materialName: 'Chicken (boneless)', uom: 'kg', category: 'Meat', requiredQty: 21.1, currentStock: 8, shortageQty: 13.1, unitCost: 240, totalCost: 5064.0 },
      { materialId: 'r3', materialName: 'Paneer', uom: 'kg', category: 'Dairy', requiredQty: 10.8, currentStock: 6, shortageQty: 4.8, unitCost: 280, totalCost: 3024.0 },
      { materialId: 'r4', materialName: 'Tomatoes', uom: 'kg', category: 'Vegetables', requiredQty: 16.8, currentStock: 28, shortageQty: 0, unitCost: 40, totalCost: 672.0 },
      { materialId: 'r5', materialName: 'Onions', uom: 'kg', category: 'Vegetables', requiredQty: 7.7, currentStock: 52, shortageQty: 0, unitCost: 32, totalCost: 246.4 },
    ],
    totalEstimatedCost: 14750,
    notes: 'Estimated peak demand based on previous weekend sales',
  },
];
